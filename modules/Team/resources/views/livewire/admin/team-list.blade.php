                    ...
                    <tr>
                        <td
                            ...
                            @if ($item->code_image)
                                <picture>
                                    <source
                                        srcset="{{ url('storage/teams/' . $item->id . '/' . $item->code_image . '_list.png') }}" />
                                    <source
                                        srcset="{{ url('storage/teams/' . $item->id . '/' . $item->code_image . '_list.webp') }}" />
                                    <img src="{{ url('storage/teams/' . $item->id . '/' . $item->code_image . '_list.png') }}"
                                        alt="{{ $item->title }}">
                                </picture>
                            @else
