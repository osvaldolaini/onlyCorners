<div>
    @props(['class' => true])
    <svg xmlns="http://www.w3.org/2000/svg" class="{{ $class }}" fill="currentColor" viewBox="0 0 400 400"
        ...
        <g id="xxx-word">
            ...
            <path d="M152.44,236H117.79V182.68h34.3v7.93H127.4v14.45h19.84v7.73H127.4v14.92h25Z" />
            ...
            <path d="M282.71,236h-8.91V182.68h8.91Z" />
