        ...
        <nav class="mt-5 space-y-1">
            ...
            <div x-init="if (window.location.href.includes('cadastros')) { openDropdown = 1; }">
                ...
                <div x-show="openDropdown === 1" x-collapse>
                    ...
                    <x-layouts.admin.side-bar-nav-link url="teams-list" active="*times*" access_page="times">
                        <x-slot name="svg">
                            <x-layout.svg.shield class="ml-2 size-6">
                            </x-layout.svg.shield>
                        </x-slot>
                        <x-slot name="title">
                            Times
                    ...
                    <x-layouts.admin.side-bar-nav-link url="championships-list" active="*campeonatos*"
                        access_page="times">
                        <x-slot name="svg">
                            <x-layout.svg.trophy class="ml-2 size-6">
                            </x-layout.svg.trophy>
                        </x-slot>
                        <x-slot name="title">
                            Campeonatos
