<div>
    ...
    <div class="mx-auto px-4 ">
        @livewire('page.detail-page-charts')
    </div>


    @if ($detail)
        <div class="w-full text-gray-900 mx-auto px-4 mt-4">
            ...
            {{-- MATCHES --}}
            <div class="space-y-4 grid grid-cols-2 space-x-2">

                @foreach (json_decode($detail->matches, true) as $match)
                    <div class="col-span-1 border rounded-lg p-4 bg-gray-50">
